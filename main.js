...
/*!***************************************!*\
  !*** ./src/app/app-routing.module.ts ***!
  \***************************************/
/*! exports provided: RootRouting */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RootRouting", function() { return RootRouting; });
...
var RootRouting = _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forRoot(routes);
...
/* harmony import */ var _services_game_session_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/game-session.service */ "./src/app/services/game-session.service.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["RootRouting"]
            ],
            providers: [_services_game_session_service__WEBPACK_IMPORTED_MODULE_6__["GameSessionService"], ngx_cookie_service__WEBPACK_IMPORTED_MODULE_7__["CookieService"]],
...
/***/ "./src/app/services/game-session.service.ts":
/*!**************************************************!*\
  !*** ./src/app/services/game-session.service.ts ***!
  \**************************************************/
/*! exports provided: GameSessionService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GameSessionService", function() { return GameSessionService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var GameSessionService = /** @class */ (function () {
    function GameSessionService(http) {
        this.http = http;
        this.hostUrl = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl;
        this.httpOptions = {
            observe: 'response',
            withCredentials: true // Required for CORS
        };
    }
    GameSessionService.prototype.getSessionAt = function (gameSessionName) {
        return this.http.get(this.hostUrl + "/game-sessions/" + gameSessionName, this.httpOptions);
    };
    GameSessionService.prototype.makeSession = function (gameSessionName) {
        var mkSessReq = this.http.post(this.hostUrl + "/game-sessions/make/" + gameSessionName, {}, this.httpOptions);
        return mkSessReq;
    };
    GameSessionService.prototype.getQuestion = function () {
        return this.http.get(this.hostUrl + "/questions/random", this.httpOptions);
    };
    GameSessionService.prototype.postMyAnswer = function (i) {
        return this.http.post(this.hostUrl + "/questions/answer", {
            answerIndex: i
        }, this.httpOptions);
    };
    GameSessionService.prototype.getBuddyAnswer = function () {
        return this.http.get(this.hostUrl + "/questions/answer", this.httpOptions);
    };
    GameSessionService = __decorate([
